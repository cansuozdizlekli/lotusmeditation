...
const RelaxScreen = () => {
  ...
  const loadSound = async () => {
    const { sound } = await Audio.Sound.createAsync(
      require('/Users/cansuozdizlekli/AwesomeProject/assets/relax.mp3')
    );
      ...
      <View style={styles.container}>
        <View style={styles.textcontainer}>
          ...
          <Text style={styles.description}>
            To "relax" is a state of loosening tension between the body and mind. Relaxation is a way to reduce stress and find inner peace. Taking slow, deep breaths and releasing tension in muscles are effective ways to relax the body.          </Text>
        </View>
