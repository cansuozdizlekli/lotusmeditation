...
const MeditationScreen = () => {
  ...
  const loadSound = async () => {
    const { sound } = await Audio.Sound.createAsync(
      require('/Users/cansuozdizlekli/AwesomeProject/assets/meditation-sound.mp3')
    );
  ...
  return (
    <ImageBackground
      source={require('/Users/cansuozdizlekli/AwesomeProject/assets/meditation-background-sc.png')}
      ...
      <View style={styles.container}>
        <View style={styles.textcontainer}>
          ...
          <Text style={styles.description}>
            Close your eyes, tune into your body, and listen to its whispers as you embark on a journey of self-discovery through guided meditation.
          </Text>
        </View>
