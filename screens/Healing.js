...
const HealingScreen = () => {
  ...
  const loadSound = async () => {
    const { sound } = await Audio.Sound.createAsync(
      require('/Users/cansuozdizlekli/AwesomeProject/assets/healing.mp3')
    );
      ...
      <View style={styles.container}>
        <View style={styles.textcontainer}>
          ...
          <Text style={styles.description}>
            The concept of "healing" involves recovery on physical, mental, and emotional levels. Meditation, breathing exercises, and relaxation techniques can be ways to heal the body. Healing involves rebalancing the body and mind.
          </Text>
        </View>
