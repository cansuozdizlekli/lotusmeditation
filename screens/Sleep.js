...
const SleepScreen = () => {
  ...
  const loadSound = async () => {
    const { sound } = await Audio.Sound.createAsync(
      require('/Users/cansuozdizlekli/AwesomeProject/assets/sleep.mp3')
    );
      ...
      <View style={styles.container}>
        <View style={styles.textcontainer}>
          ...
          <Text style={styles.description}>
            Sleep is a vital component of overall well-being and health. It allows the body and mind to rest, repair, and recharge. Quality sleep is essential for cognitive function, emotional balance, and physical health. Practices like meditation, relaxation techniques, and creating a calming bedtime routine can promote better sleep.
          </Text>
        </View>
